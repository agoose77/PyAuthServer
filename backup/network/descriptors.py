...
class Attribute(StaticValue):
    ...
    def __init__(self, value=None, notify=False,
                 complain=True, type_of=None,
                 **kwargs):
    ...
    def __str__(self):
        return "[Attribute] name: {}, type: {}, initial value: {}".format(
                                  self.name, self.type.__name__, self._value)
...
class RPC:
    ...
    def register(self, instance, interface, register_function):
        ...
        rpc_interface = RPCInterface(interface, bound_function,
                                     register_function)
