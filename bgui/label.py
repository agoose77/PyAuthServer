...
class Label(Widget):
	...
	def __init__(self, parent, name, text="", font=None, pt_size=None, color=None,
				outline_color=None, outline_size=None, outline_smoothing=None, pos=[0, 0], sub_theme='', options=BGUI_DEFAULT, **kwargs):
		"""
		...
		"""
		super().__init__(parent=parent, name=name, aspect=None, size=[0, 0], pos=pos, sub_theme=sub_theme, options=options, **kwargs)
