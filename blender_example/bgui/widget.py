...
# Scrollbar types
BGUI_HORIZONTAL_SCROLLBAR = 0
BGUI_VERTICAL_SCROLLBAR = 1
...
BGUI_INPUT_TEXT = 0
BGUI_INPUT_MIXED = 1
BGUI_INPUT_INTEGER = 2
BGUI_INPUT_FLOAT = 3
BGUI_INPUT_NUMERICAL = 4
...
class Widget:
	...
	__slots__ = ["_name", "options", "_hover", "_system", "_frozen", "_visible", 
				"_on_click", "_on_release", "_on_hover", "_on_active", "_on_mouse_exit", "_on_mouse_enter", "_parent", "_children", "_z_index", "anims"]
	...
	@is_listener.setter
	def is_listener(self, value):
		for widget in self.children.values():
			widget.is_listener = value
	...
	def _handle_key(self, key, is_shifted):
		...
		for widget in self.children.values():
			if self._hover or widget.is_listener:
